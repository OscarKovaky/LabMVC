...
namespace GlobalCity.Controllers
{
    public class CitiesController : Controller
    {
        private readonly GlobalCityContext _context;

        public CitiesController(GlobalCityContext context)
        {
            _context = context;
        }
        ...
        {
            var globalCityContext = _context.Cities.Include(c => c.CountryCodeNavigation);
            return View(await globalCityContext.ToListAsync());
        }
